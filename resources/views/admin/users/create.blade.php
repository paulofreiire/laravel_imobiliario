                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="type_of_communion" class="select2">
                                            <option value="Comunhão Universal de Bens">Comunhão Universal de
                                                Bens
                                            </option>
                                            <option value="Comunhão Parcial de Bens">Comunhão Parcial de
                                                Bens
                                            </option>
                                            <option value="Separação Total de Bens">Separação Total de
                                                Bens
                                            </option>
                                            <option value="Separação Total de Bens">Participação
                                                Final de
                                                Aquestos
                                            </option>
                                        </select>
                                ...
                                <div class="app_collapse_content">
                                    ...
                                    <div class="companies_list">
                                        ...
                                        <div class="companies_list_item mb-2">
                                            ...
                                            <p><b>Endereço:</b> Rodovia Dr. Antônio Luiz de Moura Gonzaga,
                                                3339 Bloco A
                                                Sala
                                                208</p>
                                                ...
                                                <div class="realty_list_item_content">
                                                    ...
                                                    <div class="realty_list_item_card">
                                                        ...
                                                        <div class="realty_list_item_card_content">
                                                            ...
                                                            <span
                                                                class="realty_list_item_description_content">4 Quartos<br><span>Sendo 2 suítes</span></span>
                                                        </div>
                                                    </div>
