        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.users') }}"><a class="icon-users"
                ...
                <ul class="dash_sidebar_nav_submenu">
                    <li class="{{isActive('admin.users.index')}}"><a href="{{route('admin.users.index')}}">Ver Todos</a>
                    </li>
                    <li class="{{isActive('admin.companies.index')}}"><a href="dashboard.php?app=companies/index">Empresas</a>
                    </li>
            ...
            <li class="dash_sidebar_nav_item"><a class="icon-home"
                ...
                <ul class="dash_sidebar_nav_submenu">
                    <li class="{{isActive('admin.users.create')}}"><a href="{{--{{route('admin.properties.index')}}--}}">Ver
                            Todos</a></li>
                    <li class="{{isActive('admin.users.create')}}"><a href="{{--{{route('admin.properties.create')}}--}}">Criar
                            Novo</a></li>
                </ul>
            </li>
            <li class="dash_sidebar_nav_item {{isActive('admin.contracts.index')}}"><a class="icon-file-text"
                                                                                       href="{{--{{route('admin.contracts.index')}}--}}">Contratos</a>
                <ul class="dash_sidebar_nav_submenu">
                    <li class="">{{isActive('admin.contracts.create')}}<a href="{{--{{route('admin.contracts.create')}}--}}">Criar
                            Novo</a></li>
